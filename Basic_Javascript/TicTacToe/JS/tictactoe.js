...
function placeXorO(squareNumber) {
    ...
    // Check to ensure square hasn't been selected. .some() is used to check.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {

        // Retreives HTML Element
...
// Function to parse selectedSquares array for win conditions. drawLine() will draw line if conditions are met
